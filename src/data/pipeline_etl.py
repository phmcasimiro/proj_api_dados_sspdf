...
import pandas as pd
# A importação absoluta (src.config) é correta quando executado via 'python -m'
...
# 2. TRANSFORMAÇÃO (T)
    ...
    df_consolidado = df_consolidado[['id', 'mes', 'ano', 'RegiaoAdministrativa', 'natureza', 'quantidade']].copy()
